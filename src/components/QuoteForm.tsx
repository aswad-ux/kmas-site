...
*Callback Requested:* ${form.callback ? 'Yes' : 'No'}`;
  ...
  if (submitted) {
    return (
      <section id="quote" className="bg-[#09090B] py-20 lg:py-28 border-t border-[#27272a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl mx-auto border border-[#27272a] bg-[#121212] p-10 text-center">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 border border-[#27272a] bg-[#121212] p-4 hover:border-[#DC1B1B] transition-colors group"
              >
                <div className="w-10 h-10 bg-[#27272a] flex items-center justify-center text-[#F9FAFB] group-hover:bg-[#DC1B1B] transition-colors">
          ...
          <div>
            <form
              ...
              className="border border-[#27272a] bg-[#121212] p-8 space-y-5"
            >
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-[#27272a] px-3 py-2 text-sm text-[#F9FAFB] bg-[#09090B] focus:outline-none focus:border-[#DC1B1B] transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-widest text-[#F9FAFB]/50 mb-1.5">
